...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/cobaohieu/boschdoit/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for cobaohieu/boschdoit...\n")
...
console.log("Fetching npm all-time downloads for boschdoit-ai...\n")
const npmDownloads = await fetchNpmDownloads("boschdoit-ai")
