...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new BoschdoitClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global BoschDoIt configuration settings and preferences.
   */
   ...
   *
   * Update global BoschDoIt configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the BoschDoIt server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the BoschDoIt system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all BoschDoIt instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with BoschDoIt.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that BoschDoIt is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by BoschDoIt.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current BoschDoIt configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update BoschDoIt configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all BoschDoIt sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new BoschDoIt session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific BoschDoIt session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current BoschDoIt instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the BoschDoIt system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the BoschDoIt system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the BoschDoIt system.
   */
...
export class BoschdoitClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<BoschdoitClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    BoschdoitClient.__registry.set(this, args?.key)
  }
