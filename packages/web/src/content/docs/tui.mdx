---
title: TUI
description: Using the BoschDoIt terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

BoschDoIt provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running BoschDoIt starts the TUI for the current directory.
...
When using the BoschDoIt TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to BoschDoIt. Allows you to select from available providers and add their API keys.
...
Exit BoschDoIt. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your BoschDoIt config file.
