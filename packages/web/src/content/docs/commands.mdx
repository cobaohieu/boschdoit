...
Create `.boschdoit/commands/test.md`:

```md title=".boschdoit/commands/test.md"
---
...
You can add custom commands through the BoschDoIt config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your BoschDoIt [config](/docs/config):

```json title="boschdoit.jsonc" {4-12}
{
...
- Global: `~/.config/boschdoit/commands/`
- Per-project: `.boschdoit/commands/`

```markdown title="~/.config/boschdoit/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".boschdoit/commands/component.md"
---
...
```md title=".boschdoit/commands/create-file.md"
---
...
```md title=".boschdoit/commands/analyze-coverage.md"
---
...
```md title=".boschdoit/commands/review-changes.md"
---
...
```md title=".boschdoit/commands/review-component.md"
---
...
boschdoit includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
