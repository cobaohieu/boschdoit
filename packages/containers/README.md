...
```
REGISTRY=ghcr.io/cobaohieu TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/cobaohieu TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/cobaohieu/build/bun-node:24.04
```
