...
Playwright starts the Vite dev server automatically via `webServer`, and UI tests need an boschdoit backend (defaults to `localhost:4096`).
...
- `PLAYWRIGHT_PORT` (Vite dev server port, default: `3099`)
