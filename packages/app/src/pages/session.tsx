...
import { useCodeComponent } from "@boschdoit-ai/ui/context/code"
import { LineComment as LineCommentView, LineCommentEditor } from "@boschdoit-ai/ui/line-comment"
import { SessionTurn } from "@boschdoit-ai/ui/session-turn"
import { BasicTool } from "@boschdoit-ai/ui/basic-tool"
import { createAutoScroll } from "@boschdoit-ai/ui/hooks"
import { SessionReview } from "@boschdoit-ai/ui/session-review"
import { Mark } from "@boschdoit-ai/ui/logo"
...
import { checksum, base64Encode } from "@boschdoit-ai/util/encode"
import { findLast } from "@boschdoit-ai/util/array"
...
import { UserMessage } from "@boschdoit-ai/sdk/v2"
import type { FileDiff } from "@boschdoit-ai/sdk/v2/client"
...
export default function Page() {
  ...
  createEffect(() => {
    const sessionID = params.id
    if (!sessionID) return
    const raw = sessionStorage.getItem("boschdoit.pendingMessage")
    if (!raw) return
    ...
    sessionStorage.removeItem("boschdoit.pendingMessage")
