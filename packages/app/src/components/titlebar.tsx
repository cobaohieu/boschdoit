...
import { useTheme } from "@boschdoit-ai/ui/theme"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div id="boschdoit-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" data-tauri-drag-region />
      </div>
      ...
      <div
        ...
        data-tauri-drag-region
      >
        <div id="boschdoit-titlebar-center" class="pointer-events-auto w-full min-w-0 flex justify-center lg:w-fit" />
      </div>
      ...
      <div
        ...
        data-tauri-drag-region
      >
        <div id="boschdoit-titlebar-right" class="flex items-center gap-3 shrink-0 justify-end" data-tauri-drag-region />
        <Show when={windows()}>
