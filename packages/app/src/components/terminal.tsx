...
import { resolveThemeVariant, useTheme, withAlpha, type HexColor } from "@boschdoit-ai/ui/theme"
...
export const Terminal = (props: TerminalProps) => {
  ...
  onMount(() => {
    const run = async () => {
      ...
      if (window.__BOSCHDOIT__?.serverPassword) {
        url.username = "boschdoit"
        url.password = window.__BOSCHDOIT__?.serverPassword
      }
