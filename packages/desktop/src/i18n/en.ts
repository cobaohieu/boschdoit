export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of BoschDoIt",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of BoschDoIt has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'boschdoit' command.",
  "desktop.cli.failed.title": "Installation Failed",
  "desktop.cli.failed.message": "Failed to install CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "BoschDoIt failed to start",
  "desktop.error.serverStartFailed.description":
    "The local BoschDoIt server could not be started. Restart the app, or check your network settings (VPN/proxy) and try again.",
}
