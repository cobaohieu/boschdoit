export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji BoschDoIt",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} BoschDoIt. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'boschdoit'.",
  "desktop.cli.failed.title": "Instalacja nie powiodła się",
  "desktop.cli.failed.message": "Nie udało się zainstalować CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić BoschDoIt",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera BoschDoIt. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
