export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию BoschDoIt",
  ...
  "desktop.updater.downloaded.prompt": "Версия BoschDoIt {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'boschdoit'.",
  "desktop.cli.failed.title": "Ошибка установки",
  "desktop.cli.failed.message": "Не удалось установить CLI: {{error}}",

  "desktop.error.serverStartFailed.title": "Не удалось запустить BoschDoIt",
  "desktop.error.serverStartFailed.description":
    "Не удалось запустить локальный сервер BoschDoIt. Перезапустите приложение или проверьте настройки сети (VPN/proxy) и попробуйте снова.",
}
