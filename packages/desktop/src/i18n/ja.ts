export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの BoschDoIt を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "BoschDoIt のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'boschdoit' コマンドを使用してください。",
  "desktop.cli.failed.title": "インストールに失敗しました",
  "desktop.cli.failed.message": "CLI のインストールに失敗しました: {{error}}",

  "desktop.error.serverStartFailed.title": "BoschDoIt の起動に失敗しました",
  "desktop.error.serverStartFailed.description":
    "ローカルの BoschDoIt サーバーを起動できませんでした。アプリを再起動するか、ネットワーク設定 (VPN/proxy) を確認して再試行してください。",
}
