export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'BoschDoIt",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'BoschDoIt a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'boschdoit'.",
  "desktop.cli.failed.title": "Échec de l'installation",
  "desktop.cli.failed.message": "Impossible d'installer la CLI : {{error}}",

  "desktop.error.serverStartFailed.title": "Échec du démarrage d'BoschDoIt",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur BoschDoIt local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}
