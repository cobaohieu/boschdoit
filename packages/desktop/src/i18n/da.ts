export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af BoschDoIt",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af BoschDoIt er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'boschdoit'-kommandoen.",
  ...
  "desktop.error.serverStartFailed.description":
    "Den lokale BoschDoIt-server kunne ikke startes. Genstart appen, eller tjek dine netværksindstillinger (VPN/proxy) og prøv igen.",
}
