...
import { Key } from "@boschdoit-ai/console-core/key.js"
    ...
    <Show when={isNew()}>
      <div class={styles.root}>
        <div data-component="feature-grid">
          ...
          <div data-slot="feature">
            <h3>No Lock-in</h3>
            <p>Use Zen with any coding agent, and continue using other providers with boschdoit whenever you want.</p>
          </div>
        </div>
        ...
        <div data-component="next-steps">
          <ol>
            ...
            <li>
              Run <code>boschdoit auth login</code> and select boschdoit
            </li>
            <li>Paste your API key</li>
            <li>
              Start boschdoit and run <code>/models</code> to select a model
            </li>
          </ol>
        </div>
      </div>
