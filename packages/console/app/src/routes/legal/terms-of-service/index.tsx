...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>BoschDoIt | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="BoschDoIt terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to BoschDoIt. Please read on to learn the rules and restrictions that govern your use of BoschDoIt
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("BoschDoIt," "we" and "us"). Your use of the Services in any
                ...
                <a href="/legal/privacy-policy">https://boschdoit.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-boschdoit">What is BoschDoIt?</h2>
              <p>
                BoschDoIt is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the BoschDoIt Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, BoschDoIt enables you to
              ...
              <p>
                ...
                our site located at boschdoit.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                BoschDoIt takes the privacy of its users very seriously. For the current BoschDoIt Privacy Policy, please
                click here{" "}
                <a href="https://boschdoit.ai/legal/privacy-policy">https://boschdoit.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using BoschDoIt?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by BoschDoIt;
                </li>
                <li>
              ...
              <p>
                If you use BoschDoIt with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                BoschDoIt. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                BoschDoIt has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-boschdoit-ever-change-the-services">Will BoschDoIt ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                Services"). Please see our Paid Services page <a href="/zen">https://boschdoit.ai/zen</a> for a
              ...
              <p>
                ...
                <a href="https://boschdoit.ai/auth">https://boschdoit.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href="/legal/privacy-policy">https://boschdoit.ai/legal/privacy-policy</a>, as well as the licenses
                above, to understand how we treat information you provide to us after you have stopped using our
                Services.
              </p>

              <p>
                BoschDoIt is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. BoschDoIt has the sole right to decide whether you are
              ...
              <p>
                BoschDoIt and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (BoschDoIt and all such
                parties together, the "BoschDoIt Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the BoschDoIt Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The BoschDoIt Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY BOSCHDOIT (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                BOSCHDOIT PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO BOSCHDOIT IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the BoschDoIt Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without BoschDoIt's prior written
              ...
              <p>
                ...
                disputes and claims with BoschDoIt and limits the manner in which you can seek relief from BoschDoIt. Both
                you and BoschDoIt acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, BoschDoIt's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. BoschDoIt will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. BoschDoIt will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or BoschDoIt may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND BOSCHDOIT WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and BoschDoIt are instead choosing to have claims and disputes resolved by
                ...
                you and BoschDoIt over whether to vacate or enforce an arbitration award, YOU AND BOSCHDOIT WAIVE ALL
              ...
              <p>
                ...
                BoschDoIt is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or BoschDoIt to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and BoschDoIt agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the BoschDoIt may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and BoschDoIt agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and BoschDoIt, and
                ...
                are not an employee, agent, partner, or joint venture of BoschDoIt, and you do not have any authority of
                any kind to bind BoschDoIt in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and BoschDoIt
