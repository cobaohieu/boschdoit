...
import video from "../asset/lander/boschdoit-min.mp4"
import videoPoster from "../asset/lander/boschdoit-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="boschdoit">
      {/*<HttpHeader name="Cache-Control" value="public, max-age=1, s-maxage=3600, stale-while-revalidate=86400" />*/}
      <Title>BoschDoIt | The open source AI coding agent</Title>
        ...
        <div data-component="content">
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">boschdoit.ai/install</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">boschdoit-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">cobaohieu/tap/boschdoit</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">boschdoit</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
          ...
          <section data-component="what">
            <div data-slot="section-title">
              <h3>What is BoschDoIt?</h3>
              <p>BoschDoIt is an open source agent that helps you write code in your terminal, IDE, or desktop.</p>
            </div>
            <ul>
              <li>
                <span>[*]</span>
            ...
            <div data-slot="section-title">
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{config.stats.commits}</strong> commits, BoschDoIt is used and trusted by over{" "}
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              ...
              <div>
                ...
                <p>
                  BoschDoIt does not store any of your code or context data, so that it can operate in privacy sensitive
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is BoschDoIt?">
                  BoschDoIt is an open source agent that helps you write and run code with any AI model. It's available
                  as a terminal-based interface, desktop app, or IDE extension.
                </Faq>
              </li>
              <li>
                <Faq question="How do I use BoschDoIt?">
                  The easiest way to get started is to read the <a href="/docs">intro</a>.
                </Faq>
              </li>
              <li>
                <Faq question="Do I need extra AI subscriptions to use BoschDoIt?">
                  Not necessarily, BoschDoIt comes with a set of free models that you can use without creating an
                  account. Aside from these, you can use any of the popular coding models by creating a{" "}
                  <A href="/zen">Zen</A> account. While we encourage users to use Zen, BoschDoIt also works with all
              ...
              <li>
                <Faq question="Can I use my existing AI subscriptions with BoschDoIt?">
                  Yes, BoschDoIt supports subscription plans from all major providers. You can use your Claude Pro/Max,
                  ChatGPT Plus/Pro, or GitHub Copilot subscriptions. <a href="/docs/providers/#directory">Learn more</a>
                  .
                </Faq>
              </li>
              <li>
                <Faq question="Can I only use BoschDoIt in the terminal?">
                  Not anymore! BoschDoIt is now available as an app for your <a href="/download">desktop</a> and{" "}
                  <a href="/docs/web">web</a>!
                </Faq>
              </li>
              <li>
                <Faq question="How much does BoschDoIt cost?">
                  BoschDoIt is 100% free to use. It also comes with a set of free models. There might be additional costs
              ...
              <li>
                <Faq question="Is BoschDoIt open source?">
                  Yes, BoschDoIt is fully open source. The source code is public on{" "}
          ...
          <section data-component="zen-cta">
            <div data-slot="zen-cta-copy">
              ...
              <p>
                Zen gives you access to a handpicked set of AI models that BoschDoIt has tested and benchmarked
