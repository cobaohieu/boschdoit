...
import { and, Database, eq, isNull } from "@boschdoit-ai/console-core/drizzle/index.js"
...
import { BillingTable } from "@boschdoit-ai/console-core/schema/billing.sql.js"
...
function Success(props: SuccessData) {
  return (
    <div data-slot="success">
      <p data-slot="title">You're on the BoschDoIt Black waitlist</p>
      <dl data-slot="details">
        <div>
          <dt>Subscription plan</dt>
          <dd>BoschDoIt Black {props.plan}</dd>
        </div>
        <div>
          <dt>Amount</dt>
...
export default function BlackSubscribe() {
  ...
  return (
    <>
      <Title>Subscribe to BoschDoIt Black</Title>
            ...
            <Match when={true}>
              <>
                <div data-slot="plan-header">
                  <p data-slot="title">Subscribe to BoschDoIt Black</p>
                  <p data-slot="price">
