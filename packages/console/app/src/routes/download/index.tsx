...
import desktopAppIcon from "../../asset/lander/boschdoit-desktop-icon.png"
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>BoschDoIt | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download BoschDoIt for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="BoschDoIt Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download BoschDoIt</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> BoschDoIt Terminal
            </div>
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g boschdoit-ai")}>
                <code>
                  npm i -g <strong>boschdoit-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g boschdoit-ai")}>
                <code>
                  bun add -g <strong>boschdoit-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install cobaohieu/tap/boschdoit")}>
                <code>
                  brew install <strong>cobaohieu/tap/boschdoit</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S boschdoit")}>
                <code>
                  paru -S <strong>boschdoit</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> BoschDoIt Desktop (Beta)
            </div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask boschdoit-desktop")}>
                <code>
                  brew install --cask <strong>boschdoit-desktop</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> BoschDoIt Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://boschdoit.ai/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> BoschDoIt Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://boschdoit.ai/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://boschdoit.ai/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            <li>
              <Faq question="What is BoschDoIt?">
                BoschDoIt is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use BoschDoIt?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect BoschDoIt to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, BoschDoIt works with all popular
            ...
            <li>
              <Faq question="How much does BoschDoIt cost?">
                BoschDoIt is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While BoschDoIt works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in BoschDoIt. Learn more about{" "}
