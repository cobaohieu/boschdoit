...
import { and, Database, eq, isNull, lt, or, sql } from "@boschdoit-ai/console-core/drizzle/index.js"
import { KeyTable } from "@boschdoit-ai/console-core/schema/key.sql.js"
import { BillingTable, SubscriptionTable, UsageTable } from "@boschdoit-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@boschdoit-ai/console-core/util/price.js"
import { getWeekBounds } from "@boschdoit-ai/console-core/util/date.js"
import { Identifier } from "@boschdoit-ai/console-core/identifier.js"
import { Billing } from "@boschdoit-ai/console-core/billing.js"
import { Actor } from "@boschdoit-ai/console-core/actor.js"
import { WorkspaceTable } from "@boschdoit-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@boschdoit-ai/console-core/model.js"
import { Black, BlackData } from "@boschdoit-ai/console-core/black.js"
import { UserTable } from "@boschdoit-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@boschdoit-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@boschdoit-ai/console-core/schema/provider.sql.js"
...
export async function handler(
  ...
  const FREE_WORKSPACES = [
    ...
    "wrk_01K6W1A3VE0KMNVSCQT43BG2SX", // boschdoit bench
  ]
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-boschdoit-session") ?? ""
    const requestId = input.request.headers.get("x-boschdoit-request") ?? ""
    const projectId = input.request.headers.get("x-boschdoit-project") ?? ""
    const ocClient = input.request.headers.get("x-boschdoit-client") ?? ""
    logger.metric({
      is_tream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetch(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-boschdoit-request")
          headers.delete("x-boschdoit-session")
          headers.delete("x-boschdoit-project")
          headers.delete("x-boschdoit-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo) {
    ...
    if (!billing.paymentMethodID)
      throw new CreditsError(
        `No payment method. Add a payment method here: https://boschdoit.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    if (billing.balance <= 0)
      throw new CreditsError(
        `Insufficient balance. Manage your billing here: https://boschdoit.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new MonthlyLimitError(
        `Your workspace has reached its monthly spending limit of $${billing.monthlyLimit}. Manage your limits here: https://boschdoit.ai/workspace/${authInfo.workspaceID}/billing`,
      )
    ...
    if (
      ...
      throw new UserLimitError(
        `You have reached your monthly spending limit of $${authInfo.user.monthlyLimit}. Manage your limits here: https://boschdoit.ai/workspace/${authInfo.workspaceID}/members`,
      )
