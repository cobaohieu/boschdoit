...
const mockPlugin = () => ({})
mock.module("boschdoit-copilot-auth", () => ({ default: mockPlugin }))
mock.module("boschdoit-anthropic-auth", () => ({ default: mockPlugin }))
mock.module("@gitlab/boschdoit-gitlab-auth", () => ({ default: mockPlugin }))
...
test("multiple providers can be configured simultaneously", async () => {
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      expect(providers["anthropic"].options.timeout).toBe(30990)
