...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BOSCHDOIT_CALLER", () => {
    process.env["BOSCHDOIT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BOSCHDOIT_CALLER", () => {
    process.env["BOSCHDOIT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BOSCHDOIT_CALLER", () => {
    process.env["BOSCHDOIT_CALLER"] = "unknown"
