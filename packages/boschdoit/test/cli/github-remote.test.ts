...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/boschdoit.git")).toEqual({ owner: "sst", repo: "boschdoit" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/boschdoit")).toEqual({ owner: "sst", repo: "boschdoit" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/boschdoit.git")).toEqual({ owner: "sst", repo: "boschdoit" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/boschdoit")).toEqual({ owner: "sst", repo: "boschdoit" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/boschdoit.git")).toEqual({ owner: "sst", repo: "boschdoit" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/boschdoit")).toEqual({ owner: "sst", repo: "boschdoit" })
})
